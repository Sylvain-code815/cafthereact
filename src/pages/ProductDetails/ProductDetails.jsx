...
const ProductDetails = () => {
  ...
  if (error) {
    return (
      <div className="pd-error">
        ...
        <p>{error}</p>
        <Link to="/" className="btn-filled pd-error-link">
          Retour à l'accueil
        </Link>
      </div>
    );
  ...
  return (
    <div className="pd-container">
      <SEO title={produit.nom_produit} description={produit.description || `Découvrez ${produit.nom_produit} sur CafThé. ${produit.origine ? `Origine : ${produit.origine}.` : ""} Qualité premium, livraison rapide.`} />
      {/* Breadcrumb */}
      <Breadcrumb items={[
      ...
      <div className="pd-section">
        ...
        <div className="pd-info">
          ...
          <div className="pd-purchase-box">
            ...
            <button
              className="btn-filled pd-add-to-cart"
