      ...
      <section className="engagements-section">
        ...
        <div className="engagements-grid">
          <div className="engagement-item">
            <img src="/Images/Icon/engagement-agriculture.svg" alt="agriculture" role="img" />
            <h3>Agriculture Durable</h3>
            <p>Produits issus de l'agriculture biologique et du commerce équitable</p>
          </div>
          <div className="engagement-item">
            <img src="/Images/Icon/engagement-qualite.svg" alt="qualité" role="img" />
            <h3>Qualité Premium</h3>
            <p>Sélection rigoureuse des meilleurs terroirs mondiaux</p>
          </div>
          <div className="engagement-item">
            <img src="/Images/Icon/engagement-passion.svg" alt="passion" role="img" />
            <h3>Passion & Expertise</h3>
            <p>Plus de 20 ans d'expérience dans l'art du thé et du café</p>
          </div>
          <div className="engagement-item">
            <img src="/Images/Icon/engagement-livraison.svg" alt="livraison" role="img" />
